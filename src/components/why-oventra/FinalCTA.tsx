...
import { COLORS, bodyLgClass } from './Shared';
...
export const FinalCTA = () => (
  <footer className="relative py-28 md:py-40 flex items-center justify-center overflow-hidden px-6" style={{ background: COLORS.maroon }}>
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative z-10 text-center max-w-3xl">
      <h2 className="font-display text-5xl md:text-7xl lg:text-[4.5rem] text-white mb-8 font-semibold tracking-[-0.03em] leading-[0.95]">READY TO EXPERIENCE THE <span style={{ color: '#fff', textDecoration: 'underline', textDecorationColor: COLORS.blue }}>OVENTRA</span> DIFFERENCE?</h2>
