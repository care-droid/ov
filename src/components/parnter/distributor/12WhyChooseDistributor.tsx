...
const pillars = [
  ...
  },
  {
    ...
    body: "Whether you're launching a new collection, managing routine distributor orders, or conducting a sales conference, OVENTRA ensures every order is captured accurately, processed efficiently, and monitored in real time.",
  },
];

const WhyChooseDistributor = () => {
...
export default WhyChooseDistributor;