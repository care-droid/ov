...
const headlineWords = ["Introducing", "OVENTRA", "Dealer", "Ordering"];
    ...
    <MotionProvider>
      ...
      >
        ...
        <div className="relative z-10 mt-20 mx-auto max-w-5xl px-6 text-center sm:px-10">
          ...
          >
            OVENTRA connects dealers, distributors, and manufacturers on a
            single digital platform. Dealers receive their own secure login
            to access a personalized ordering portal where they can explore
            products, place orders with their assigned distributor, and
            monitor every order in real time. Manufacturers benefit from
            improved order visibility, enhanced channel collaboration, and
