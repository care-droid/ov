...
const challenges: Challenge[] = [
  {
    title: "Phone & WhatsApp Orders",
    body: "Dealers place orders through multiple communication channels, making order management difficult.",
  },
  {
    title: "Missing Product Information",
    body: "Dealers often don't have access to the latest catalogue, pricing, or newly launched products.",
  },
  {
    title: "Ordering Mistakes",
    body: "Incorrect product codes, sizes, colors, and quantities frequently lead to returns and order corrections.",
  },
  {
    title: "Slow Communication",
    body: "Dealers depend on distributors or sales representatives for product information and order confirmation.",
  },
  {
    title: "No Order Tracking",
    body: "Dealers remain unaware of the order status until they receive a manual update.",
  },
  {
    title: "Limited Business Visibility",
    body: "Manufacturers cannot analyze dealer buying patterns or product demand effectively.",
  },
  {
    title: "Poor Buying Experience",
    body: "Manual ordering discourages repeat purchases and affects dealer satisfaction.",
  },
];
...
export default function PartnerMeetChallenges() {
  ...
  >
    <div>
      ...
      >
        As dealer networks expand, manual order collection becomes
