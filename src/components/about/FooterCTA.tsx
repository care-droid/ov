  ...
  return (
    <section className="py-32 relative overflow-hidden bg-[#4A0E1A] text-center">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6">
        ...
        <button className="px-10 py-4 bg-white text-[#4A0E1A] font-bold rounded-full hover:bg-[#E8B4BE] transition-all transform hover:scale-105">Join The Transformation</button>
      </div>
    </section>
  );
}