      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-6 sm:px-10 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="order-1 lg:order-2">
          ...
          <motion.p
            ...
            style={{ color: `${INK}99` }}
          >
            Imagine a distributor browsing your product catalogue. Instead of searching
            manually or calling the sales team, they simply scan the QR code on the
            product display. Within seconds, the product opens on the mobile app with
          ...
          <motion.p
            ...
            style={{ color: `${INK}99` }}
          >
            They select the variant and add it directly to their order. This simple
            workflow eliminates article number mistakes while making ordering
            significantly faster for both distributors and manufacturers.
          </motion.p>
