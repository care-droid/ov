 ...
 * UI Concept ported from "The Certificate of Record": a contents index
 * sits above a framed certificate card bearing a wax-style seal, styled
 * the way an old trade house would log an official finding —
 * restrained, formal, built to last rather than to impress for a moment.
 *
 * DATA: unchanged — copied verbatim from the original BusinessBenefits.
 *
...
const benefits = [
  {
    ...
    body: "Allow dealers to place orders independently without relying on sales representatives.",
    spec: "SPEC NO. 01",
  },
  {
    id: "catalogue",
    ...
    body: "Provide access to your complete product catalogue with high-quality images and specifications.",
    spec: "SPEC NO. 02",
  },
  {
    id: "search",
    ...
    body: "Find products instantly using Article Number, Product Name, Category, Collection, and Keywords.",
    spec: "SPEC NO. 03",
  },
  {
    id: "variants",
    ...
    body: "Support multiple Sizes, Colors, Designs, and Packaging Options within a single product.",
    spec: "SPEC NO. 04",
  },
  {
    id: "visibility",
    icon: Eye,
    tag: "Visibility",
    title: "Dealer-Specific Product Visibility",
    body: "Display only products relevant to the dealer's assigned distributor or region.",
    spec: "SPEC NO. 05",
  },
  {
    id: "history",
    ...
    tag: "History",
    title: "Order History",
    body: "View previous purchases and quickly reorder frequently purchased products.",
    spec: "SPEC NO. 06",
  },
  {
    id: "tracking",
    ...
    body: "Track every stage of the order lifecycle.",
    spec: "SPEC NO. 07",
  },
  {
    id: "dashboard",
    ...
    body: "Dealers can monitor Current Orders, Pending Orders, Purchase History, and Frequently Purchased Products.",
    spec: "SPEC NO. 08",
  },
  {
    id: "cloud",
    ...
    body: "Access OVENTRA anytime from any location using a smartphone or tablet.",
    spec: "SPEC NO. 09",
  },
];
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="font-display text-[33px] sm:text-[56px] lg:text-[58px] text-[#F7F1E4] leading-[1.05] tracking-[-0.02em] font-semibold">
              Everything your dealer network needs, in one app
            </h2>
