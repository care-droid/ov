...
/**
 * SECTION 7 — "Every Kind of Meet, One Route"
 * Structure: instead of a tab bar, the six formats sit as numbered stops
 * on a single horizontal route line — closer to a subway map than a menu.
 * Click a stop, or step through with the arrows either side.
 *
 * Background: white → maroon (top → bottom), the same direction as
 * Powerful Features, so this section's white top meets Business
 * Benefits' white floor directly above it.
 *
 * Assets expected at the project root:
 *  - features1.jpg, features2.jpg, features3.jpg (cycled across the 6 stops)
 */
...
export default function PartnerMeetTypes() {
