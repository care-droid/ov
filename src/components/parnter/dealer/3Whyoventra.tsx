...
const benefits: Benefit[] = [
  {
    icon: Eye,
    title: "Improve Market Visibility",
    body: "Understand dealer buying patterns across different regions.",
  },
  {
    icon: TrendingUp,
    title: "Increase Sales",
    body: "Enable dealers to order more frequently.",
  },
  {
    icon: Rocket,
    title: "Launch Products Faster",
    body: "Introduce new collections digitally without waiting for printed catalogues.",
  },
  {
    icon: Users,
    title: "Reduce Sales Team Dependency",
    body: "Allow dealers to place routine orders independently.",
  },
  {
    icon: BarChart3,
    title: "Better Business Intelligence",
    body: "Track Dealer Performance, Product Demand, Regional Trends, and Collection Performance through comprehensive dashboards.",
  },
];
