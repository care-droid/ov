...
function PlaceholderScreen({ id }: { id: number }) {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-3 rounded-[1.6rem] border border-black/[0.06] bg-gradient-to-b from-[#F3F5F8] to-[#E7ECF3] p-4">
      <span
      ...
      <div className="w-full space-y-2">
        <div className="mx-auto h-2 w-4/5 rounded-full bg-black/10" />
        <div className="mx-auto h-2 w-3/5 rounded-full bg-black/10" />
        <div className="mx-auto h-2 w-2/3 rounded-full bg-black/10" />
      </div>
    </div>
  );
}
...
export default function PartnerAppShowcase() {
  ...
  return (
    <section className="relative w-full bg-white" style={{ zIndex: 1 }}>
      {/* Top benefit strip */}
      <div style={{ backgroundColor: ACCENT }} className="w-full py-4">
        <motion.div
      ...
      {/* Content panel + straight-line carousel */}
      <div className="mx-auto max-w-6xl px-4 pb-20 pt-14 sm:pt-16">
