...
const benefits: Benefit[] = [
  {
    ...
    body: "Distributors can place orders independently without waiting for sales representatives, significantly reducing order turnaround time.",
  },
  {
    icon: Target,
    title: "Improved Accuracy",
    body: "Digital product selection minimizes manual errors related to article numbers, sizes, colours, and quantities.",
  },
  {
    icon: Sparkles,
    title: "Professional Experience",
    body: "Deliver a modern buying experience that reflects your brand and enhances distributor satisfaction.",
  },
  {
    icon: Activity,
    title: "Real-Time Business Visibility",
    body: "Know exactly how your distribution network is performing with live dashboards and analytics.",
  },
  {
    icon: Users,
    title: "Better Sales Team Productivity",
    body: "Free your sales team from routine order collection so they can focus on business development and customer engagement.",
  },
  {
    icon: PackageCheck,
    title: "Faster Order Processing",
    body: "Orders are available digitally as soon as distributors complete their booking, enabling faster fulfilment.",
  },
];
  ...
  return (
    <div className="relative z-10 w-[290px]">
      <div className="rounded-2xl bg-white p-4 shadow-2xl">
        ...
        <div className="mt-3">
          <p className="text-sm font-medium text-gray-900">Signature Sneaker Line</p>
...
function ProductivityMockup() {
  const tasks = ["Process order", "Review catalogue", "Follow up call"];
  return (
    <div className="relative z-10 w-[300px] rounded-2xl bg-white p-5 shadow-2xl">
