          ...
          {BLOG_POSTS.map((post, index) => (
            ...
            >
              ...
              <div className="relative">
                <div className="relative h-56 w-full overflow-hidden rounded-[22px] shadow-[0_18px_40px_rgba(0,0,0,0.12)] sm:h-64 lg:h-72">
                  <Image
                    ...
                    alt={post.title}
                    fill
                    className="object-container transition-transform duration-[600ms] ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-105"
              ...
              <div className="flex flex-1 flex-col p-10">
                <h3 className="line-clamp-2 text-3xl font-bold tracking-tight leading-tight text-slate-900 transition-colors duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:text-[#01397b] sm:text-4xl">
  {post.title}
</h3>
