...
const challenges: Challenge[] = [
  {
    ...
    body: "Phone calls, emails, and spreadsheets are slow, difficult to track, and prone to errors.",
  },
  {
    title: "Scattered order data",
    body: "Sales teams spend hours consolidating order data from different distributors and channels.",
  },
  {
    title: "Product selection errors",
    body: "Wrong article numbers, incorrect sizes, or inaccurate quantities trigger frequent order revisions.",
  },
  {
  ...
  },
  {
    ...
    body: "Management can't track distributor activity, order status, or sales performance while it's happening.",
  },
  {
    title: "Inconsistent distributor experience",
    body: "Distributors expect a modern ordering process, not outdated paperwork and manual follow-ups.",
  },
];

const wheelItems = challenges.map(c => c.title);

export default function DistributorChallenges() {
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pt-10 sm:pt-14">
        ...
        >
          <div>
            ...
            >
              Even the best-managed distribution networks struggle with manual order
              collection, fragmented communication, and delayed processing.
            </motion.p>
          </div>
        </motion.div>
      </div>
