...
const steps = [
  {
    ...
    image: "/DistributorDealor/new/Dealer1.png",
  },
  {
    id: 2,
    title: "Browse Digital Catalogue",
    description: "Explore the latest collections, new arrivals, and best sellers with high-resolution imagery.",
    bullets: ["Product Specifications", "Real-time stock info", "Category filtering"],
  ...
  },
  {
    ...
    description: "Distributors receive the order instantly on their panel for review and processing.",
  ...
  },
  {
    ...
    description: "Dealers receive immediate confirmation once the order is accepted by the distributor.",
    bullets: ["Status updates", "Order summary", "Digital receipts"],
              ...
              {steps.map((step, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="absolute"
                  >
                    <div className="relative h-full w-full overflow-hidden rounded-[2.5rem] bg-white shadow-[0_40px_100px_-20px_rgba(0,0,0,0.15)] ring-4 ring-white transition-all duration-700">
                      <Image
                        src={step.image}
                        alt={step.title}
                        fill
